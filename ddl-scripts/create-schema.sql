...
CREATE TABLE IF NOT EXISTS resource_user0 (
    resource_key VARCHAR(400) NOT NULL,
    resource BYTEA NOT NULL,
    user_id UUID NOT NULL,
    hash_bucket_id BIGINT NOT NULL,
    seq_num BIGINT NOT NULL,
    modification_time BIGINT NOT NULL,
    PRIMARY KEY(hash_bucket_id, seq_num)
);

CREATE INDEX IF NOT EXISTS resource_user0_id_idx ON resource_user0(user_id);


CREATE TABLE IF NOT EXISTS resource_user1 (
    resource_key VARCHAR(400) NOT NULL,
    resource BYTEA NOT NULL,
    user_id UUID NOT NULL,
    hash_bucket_id BIGINT NOT NULL,
...
CREATE INDEX IF NOT EXISTS resource_user1_id_idx ON resource_user1(user_id);


CREATE TABLE IF NOT EXISTS resource_user2 (
    resource_key VARCHAR(400) NOT NULL,
    resource BYTEA NOT NULL,
    user_id UUID NOT NULL,
    hash_bucket_id BIGINT NOT NULL,
